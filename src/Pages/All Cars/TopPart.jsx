                ...
                <div className='hostprofile'>
                    ...
                    <div className="hostprofile6">
                        <div className="hostprofile7">
                            ...
                            <p className={location.pathname === "/calender" ? "hostprofile8" : "hostprofile9"} onClick={() => navigate("/calender")}>Rides</p>
                            <p className={location.pathname === "/workreport" ? "hostprofile8" : "hostprofile9"} onClick={() => navigate("/workreport")}>Offers</p>
                        </div>
                    </div>
                </div>
            </div>
